      ...
      return (
        <form className="Account">
          <div className="text-filed">
            <input type="text" value={this.state.phone} onChange={this.handleAccountChange} placeholder="收件人"/>
          </div>
          <div className="text-filed">

            <input type="password" value={this.state.password} onChange={this.handlePasswordChange} placeholder="收件人地址" />
          </div>
          <div className="box">
